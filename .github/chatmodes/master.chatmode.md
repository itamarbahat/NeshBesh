---
description: "👑 NeshBesh Master Orchestrator. Plans features, decomposes tasks, and coordinates cross-system changes across UI / Logic / FX / Debug. Analyzes requests and delegates to specialized sub-agents."
tools: ['codebase', 'search', 'usages', 'findTestFiles', 'githubRepo', 'problems', 'terminalLastCommand']
---
...
**Source of truth**: [.github/agents/master.agent.md](../agents/master.agent.md) and [CLAUDE.md](../../CLAUDE.md).
